...
try {
    ...
    //Content
    $mail->isHTML(true);
    $mail->Subject = 'I Love You Sayang Aqila ❤︎';
    $mail->Body    = 'Happy Valentine Day My Love Aqila ❤︎. I love you so much. You are the best thing that has ever happened to me ❤';
